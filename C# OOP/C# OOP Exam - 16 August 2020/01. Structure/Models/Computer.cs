namespace OnlineShop.Models
{
    ...
    public abstract class Computer : Product, IComputer
    {
        ...
        => this.Components.Count() == 0 ? this.OverallPerformance : this.Components.Average(component => component.OverallPerformance) + this.OverallPerformance;

        public override decimal Price 
            => this.Price + this.Components.Sum(component => component.Price) + this.Peripherals.Sum(peripheral => peripheral.Price);
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine(
                $"Peripherals ({this.Peripherals.Count()}); Average Overall Performance ({this.Peripherals.Average(peripheral => peripheral.OverallPerformance)}):");
