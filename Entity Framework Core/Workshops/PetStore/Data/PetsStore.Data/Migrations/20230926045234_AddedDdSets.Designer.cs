...
namespace PetsStore.Data.Migrations
{
    ...
    [Migration("20230926045234_AddedDdSets")]
    partial class AddedDdSets
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetsStore.Data.Models.ClientCard", b =>
                {
                    ...
                    b.HasIndex("ClientIdd")
                        .IsUnique()
                        .HasFilter("[ClientIdd] IS NOT NULL");
            ...
            modelBuilder.Entity("PetsStore.Data.Models.ClientCard", b =>
                {
                    b.HasOne("PetsStore.Data.Models.Client", "Client")
                        .WithOne()
                        .HasForeignKey("PetsStore.Data.Models.ClientCard", "ClientIdd");
